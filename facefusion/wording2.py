WORDING =\
{
	...
	'stop_button_label': 'ngừng',
	'clear_button_label': 'xóa',
	...
	'execution_providers_checkbox_group_label': 'bộ xử lý',
	'execution_thread_count_slider_label': 'số luồng thực thi',
	'execution_queue_count_slider_label': 'hàng đợi thực thi',
	'face_analyser_direction_dropdown_label': 'hướng phân tích khuôn mặt',
	'face_analyser_age_dropdown_label': 'độ tuổi khuôn mặt',
	'face_analyser_gender_dropdown_label': 'giới tính khuôn mặt',
	'reference_face_gallery_label': 'khuôn mặt',
	'face_recognition_dropdown_label': 'nhận dạng khuôn mặt',
	'reference_face_distance_slider_label': 'khoảng cách khuôn mặt',
	'max_memory_slider_label': 'ram tối đa',
	'output_image_or_video_label': 'kết quả',
	'output_path_textbox_label': 'xuất file',
	'output_image_quality_slider_label': 'OUTPUT IMAGE QUALITY',
	'output_video_encoder_dropdown_label': 'giải mã video',
	'output_video_quality_slider_label': 'chất lượng video',
	'preview_image_label': 'xem trước',
	'preview_frame_slider_label': 'xem trước khung hình',
	'frame_processors_checkbox_group_label': 'xử lý khung hình',
	'face_swapper_model_dropdown_label': 'mô hình hoán đổi',
	'face_enhancer_model_dropdown_label': 'mô hình tăng cường',
	'face_enhancer_blend_slider_label': 'pha trộn tăng cường ',
	'frame_enhancer_model_dropdown_label': 'mô hình tăng cường khung hình',
	'frame_enhancer_blend_slider_label': 'pha trộn khung hình',
	'common_options_checkbox_group_label': 'lựa chọn khác',
	'temp_frame_format_dropdown_label': 'định dạng khung hình',
	'temp_frame_quality_slider_label': 'chât lượng khung hình',
	'trim_frame_start_slider_label': 'bắt đầu từ khung hình',
	'trim_frame_end_slider_label': 'kết thúc ở khung hình',
	'source_file_label': 'khuôn mặt mới',
	'target_file_label': 'khuôn mặt cũ',
